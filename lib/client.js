		...
		children: (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				(0, react_jsx_runtime.jsx)("div", {
					...
					children: Array.from({ length: data.days }, (_, d) => (0, react_jsx_runtime.jsx)("span", {
						style: {
							position: "absolute",
							left: 104 + d * DAY_W + DAY_W / 2,
				...
				(0, react_jsx_runtime.jsx)("div", {
					...
					children: lanes.map((l) => (0, react_jsx_runtime.jsx)("div", {
						...
						children: l.name.length > 10 ? l.name.slice(0, 10) + "…" : l.name
					}, l.id))
				}),
				(0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [
						...
						Array.from({ length: data.days }, (_, d) => (0, react_jsx_runtime.jsx)("g", { children: (0, react_jsx_runtime.jsx)("line", {
							x1: d * DAY_W,
							y1: TOPH,
							x2: d * DAY_W,
							y2: H - 10,
							...
							return (0, react_jsx_runtime.jsxs)("g", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)("text", {
										x: pts[0].x,
										y: pts[0].y - (4 + Math.sqrt(reqs[0].events) / 2.2) - 5,
										textAnchor: "middle",
										fill: dimmed ? T.faint : T.muted,
										fontSize: 8.5,
										fontFamily: T.mono,
										children: sid.slice(0, 6)
									}),
						...
						data.requirements.map((r) => {
							...
							const tangled = sess !== void 0 && sess.projects.length > 1;
							return (0, react_jsx_runtime.jsxs)("g", {
								opacity: dimmed ? .14 : 1,
								...
								children: [
									tangled && (0, react_jsx_runtime.jsx)("circle", {
										cx: px(r),
										cy: py(r),
										r: radius + 3,
										fill: "none",
									...
									(0, react_jsx_runtime.jsx)("circle", {
										...
										cy: py(r),
										r: radius,
										fill: rgba(hueOf(r.proj), .9),
										stroke: T.bg,
										strokeWidth: 1,
										children: (0, react_jsx_runtime.jsx)("title", { children: r.req + " · " + dayLabelOf(base, r.day) + " · " + r.events + " events · " + (r.proj === "unk" ? "未归属" : r.proj.slice(0, 10)) + (tangled ? " · 缠绕" : "") })
									}),
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("div", {
								...
								children: "节点=需求(大小=事件量) · 虚线=会话线 · 金环=缠绕 · 切换按工作段计"
							})
						]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
