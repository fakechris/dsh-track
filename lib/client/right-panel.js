...
function buildPanelHtml() {
  ...
  <div class="inv-body">
    ...
    <div class="inv-section">
      <div class="inv-section-title">会话结构图 <span class="inv-graph-session"></span>
...
async function renderGraph() {
    ...
    el.innerHTML = renderGraphHtml(doc, sessionId);
}
...
function setPanelOpen(open) {
    ...
    if (fab !== null)
        fab.hidden = open;
    if (trackTab !== null)
        trackTab.setAttribute('aria-selected', String(!open));
    try {
