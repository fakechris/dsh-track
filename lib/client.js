			...
			children: (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					(data.links ?? []).map((l, k) => {
						...
						const b = l.toSession !== void 0 ? data.requirements.find((r) => r.id === l.to && r.sessionId === l.toSession) : reqMap.get(l.to);
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("div", {
								...
								children: "节点=需求(大小=工作量) · 紫线=子代理继承 · 黄虚线=需求派生 · 青虚线=跨会话共执行 · 泳道=会话触碰的全部仓库 · 金环=跨项目缠绕"
							})
						]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
